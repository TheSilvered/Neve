...
void test_ctxCurMove(void) {
    ...
    testAssert(ctx.cursors.items[0].selStart == 2);
    testAssert(ctx.cursors.items[1].idx == 4);
    testAssert(ctx.cursors.items[1].selStart == 4);
    testAssert(ctx.cursors.items[2].idx == 7);
    testAssert(ctx.cursors.items[2].selStart == 6);

    ctxCurMove(&ctx, 2, 5);
    testAssert(ctx.cursors.len == 3);
    testAssert(ctx.cursors.items[0].idx == 4);
    testAssert(ctx.cursors.items[0].selStart == 4);
    testAssert(ctx.cursors.items[1].idx == 5);
    testAssert(ctx.cursors.items[1].selStart == 2);
    testAssert(ctx.cursors.items[2].idx == 7);
    testAssert(ctx.cursors.items[2].selStart == 6);
    ...
    testAssert(ctx.cursors.items[3].selStart == 8);
    ...
    testAssert(ctx.cursors.items[2].selStart == 8);
